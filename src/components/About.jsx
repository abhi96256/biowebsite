...
const About = () => {
    ...
    const title = getContent(
        'about',
        'title',
        'Dr.D.Suresh is an Indian Administrative Service (IAS) officer committed to delivering efficient governance, transparent administration, and sustainable development.'
    );
