...
const SocialIcon = ({ name }) => {
    ...
    switch (name) {
        ...
        case 'x':
            return (
                <svg {...common}>
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.744l7.727-8.835L1.254 2.25H8.08l4.713 5.783L18.244 2.25zm-1.161 17.52h1.833L7.084 4.126H5.117L17.083 19.77z" />
                </svg>
            );
        case 'facebook':
            return (
    ...
    return (
        <section className="contact-premium-section" id="contact">
            <div className="max-w-container-max px-margin-mobile md-px-margin-desktop relative z-10">
                ...
                <div className="contact-premium-split">
                    <div className="contact-info-panel">
                        {contactInfo.map((item) => {
                            ...
                            return (
                                <Tag key={item.label} className="contact-info-item" {...linkProps}>
                                    <div className="contact-info-item-inner">
                                        <span className="contact-info-accent" aria-hidden="true" />
                                        <div className="contact-icon-wrapper">
                                            <span className="material-symbols-outlined contact-icon" aria-hidden="true">
                                                {item.icon}
                                            </span>
                                        </div>
